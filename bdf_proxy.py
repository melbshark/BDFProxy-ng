...
#    Based on BDFProxy by Josh Pitts                                         #
#                                                                            #
...
class ProxyMaster(controller.Master):
    ...
    def archive_files(self, archFileBytes, archInfo, include_dirs=False):
        ...
        try:
                ...
                for filename in files_list:
                    ...
                    if patchCount >= archiveType.patchCount:
                        ...
                        if patchResult:
                            ...
                            EnhancedOutput.logging_info("{0} patching failed. Keeping original file.".format(filename))
            ...
            EnhancedOutput.print_error("Error while creating the archive: {0}".format(exc))
            EnhancedOutput.print_error("Returning the original file")
...
EnhancedOutput.print_info("Starting BDFProxy-ng v0.1")
EnhancedOutput.print_info("Authors: @davbarbato | anathema@anche.no <-> the.midnite.runr@gmail.com")
